...
if ($_POST) {
    $team_name = $_POST['teamB_name'];
    $logo = $_POST['logo'];
    $category = $_POST['category_name'];
    $teamId = $_POST['teamId'];


    $sql = "UPDATE `teamb` SET `teamB_name`='$team_name',`logo`='$logo',`fk_categoryId`='$category' WHERE teamId = {$teamId}";
...
<body>
    <div class="container">
        ...
        <div class="alert alert-<?php echo $class; ?>" role="alert">
            ...
            <a href='../updateB.php?id=<?= $id; ?>'><button class="btn btn-warning" type='button'>Back</button></a>
